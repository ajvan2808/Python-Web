...
# import json
# def doc_file_json(duongdan):
#     f=open(duongdan,encoding='utf-8')
#     du_lieu = json.load(f)
#     f.close()
#     return du_lieu

# def ghi_file_json(duongdan, noidung):
#     f = open(duongdan,'w', encoding='utf-8')
#     json.dump(noidung,f,indent=4, ensure_ascii=False)
#     f.close()
#     return True
